...
func TestCapacityScheduling(t *testing.T) {
	...
	cfg := &scheconfig.CapacitySchedulingArgs{
	...
	node.Status.Allocatable = v1.ResourceList{
		...
		v1.ResourceCPU:    *resource.NewQuantity(200, resource.DecimalSI),
	}
	...
	for _, tt := range []struct {
	...
	}{
		{
			...
			existPods: []*v1.Pod{
				...
				util.MakePods("t1-p2", "ns1", 50, 10, midPriority, "t1-p2", ""),
				util.MakePods("t1-p3", "ns1", 50, 10, lowPriority, "t1-p3", ""),
			},
			addPods: []*v1.Pod{
				util.MakePods("t1-p4", "ns2", 50, 10, midPriority, "t1-p4", ""),
				util.MakePods("t1-p5", "ns2", 50, 10, midPriority, "t1-p5", ""),
				util.MakePods("t1-p6", "ns2", 50, 10, lowPriority, "t1-p6", ""),
			},
			elasticQuotas: []*v1alpha1.ElasticQuota{
				{
		...
		},
		{
			...
			existPods: []*v1.Pod{
				...
				util.MakePods("t2-p2", "ns1", 50, 10, lowPriority, "t2-p2", ""),
				util.MakePods("t2-p3", "ns2", 50, 10, midPriority, "t2-p3", ""),
				util.MakePods("t2-p4", "ns2", 50, 10, lowPriority, "t2-p4", ""),
			},
			addPods: []*v1.Pod{
				util.MakePods("t2-p5", "ns1", 50, 10, midPriority, "t2-p5", ""),
				util.MakePods("t2-p6", "ns2", 50, 10, midPriority, "t2-p6", ""),
			},
			elasticQuotas: []*v1alpha1.ElasticQuota{
				{
					TypeMeta:   metav1.TypeMeta{Kind: "ElasticQuota", APIVersion: "scheduling.sigs.k8s.io/v1alpha1"},
		...
		},
		{
			...
			existPods: []*v1.Pod{
				...
				util.MakePods("t3-p2", "ns1", 50, 10, lowPriority, "t3-p2", ""),
				util.MakePods("t3-p3", "ns2", 50, 10, highPriority, "t3-p3", ""),
				util.MakePods("t3-p4", "ns2", 50, 10, lowPriority, "t3-p4", ""),
			},
			addPods: []*v1.Pod{
				util.MakePods("t3-p5", "ns1", 50, 10, midPriority, "t3-p5", ""),
				util.MakePods("t3-p6", "ns2", 50, 10, midPriority, "t3-p6", ""),
			},
			elasticQuotas: []*v1alpha1.ElasticQuota{},
			expectedPods: []*v1.Pod{
				{
		...
		{
			name:       "inter namespace preempt without quota",
			namespaces: []string{"ns1", "ns2"},
			existPods: []*v1.Pod{
				util.MakePods("t4-p1", "ns1", 50, 10, highPriority, "t4-p1", ""),
				util.MakePods("t4-p2", "ns1", 50, 10, lowPriority, "t4-p2", ""),
				util.MakePods("t4-p3", "ns1", 50, 10, lowPriority, "t4-p3", ""),
				util.MakePods("t4-p4", "ns2", 50, 10, highPriority, "t4-p4", ""),
			},
			addPods: []*v1.Pod{
				util.MakePods("t4-p5", "ns2", 50, 10, midPriority, "t4-p5", ""),
				util.MakePods("t4-p6", "ns2", 50, 10, midPriority, "t4-p6", ""),
			},
			elasticQuotas: []*v1alpha1.ElasticQuota{},
			expectedPods: []*v1.Pod{
				{
				...
				{
					ObjectMeta: metav1.ObjectMeta{Name: "t4-p5", Namespace: "ns2"},
				},
				{
					ObjectMeta: metav1.ObjectMeta{Name: "t4-p6", Namespace: "ns2"},
				},
			},
		},
	} {
